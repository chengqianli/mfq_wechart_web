										...
										<div class="modal-body">
											<div id="testmodal" style="padding: 5px 20px;">
												<form id="addDeptForm" method="post" class="form-horizontal calender" role="form">
													<input type="hidden" name="companyId" id="deptNew_companyId">
													...
													<div class="modal-body">
														<div id="testmodal" style="padding: 5px 20px;">
															...
															<form id="addUserForm" class="form-horizontal calender" role="form">
																...
																<div class="form-group" style="margin-bottom: 5px;">
																	<label class="control-label col-md-3 col-sm-3 col-xs-12">组</label>
																	<div class="col-md-9 col-sm-9 col-xs-12">
																		<select name="deptIds" id="deptLevel2" class="form-control">
																			<!-- <option value=" ">请选择...</option> -->
																		</select>
														...
														<div id="testmodal" style="padding: 5px 20px;">
															...
															<form id="addUserForm" class="form-horizontal calender" role="form">
																...
																<div class="form-group" style="margin-bottom: 5px;">
																	...
																	<div class="col-md-9 col-sm-9 col-xs-12">
																		<select name="deptIds" id="deptLevel2" class="form-control">
																			<option value=" ">贷后一组</option>
																			<option value=" ">贷后二组</option>
																			<option value=" ">贷后三组</option>
																			<option value=" ">贷后四组</option>
																			<option value=" ">贷后五组</option>
																		</select>
																...
																<div class="form-group" style="margin-bottom: 5px;">
																	<button type="button" class="btn btn-success antoclose">添加成员</button>
																</div>
										...
										<div class="modal fade wwsetting_roles" tabindex="-1" role="dialog" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
														<div id="testmodal" style="padding: 5px 20px;">
															<form id="roleFormId" class="form-horizontal calender appendKuang" role="form">

																<div class="form-group">
										                            <label class="col-sm-3 col-md-3 control-label">姓名：</label>
										                            <div class="col-sm-6 col-md-6">
										                                <input type="text" class="form-control" id="debitMoney" name="debitMoney" value="张三" readonly style="border:0;background:#fff;"/>
										                            </div>
										                        </div>
										                        <div class="form-group">
			...
			$.ajax({
				...
				success : function(result) {
					...
					for (var i = 0; i < userList.length; i++) {
						...
						var bntHol="<button type='button' class='btn btn-info btn-xs' data-toggle='modal' data-target='.wwsetting_roles' style='cursor: pointer;'>请假</button>";
						...
						"</p></div><div class='col-xs-12 col-sm-7 emphasis'>" +bntHol+ bntRole + bntUpt + bntDel + "</div></div></div></div>";
					}
