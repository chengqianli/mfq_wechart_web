                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback" style="margin-top:20px;">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <button type="button" id="searchBtn4" class="btn btn-success" data-toggle="modal" data-target="#debit_modal">分配外催</button>
                                        <button type="button" id="searchBtn5" class="btn btn-success" data-toggle="modal" data-target="#wwdebit_modal">案件回收</button>
                                        <button type="button" id="searchBtn2" class="btn btn-success" data-toggle="modal" data-target="#debit_modalss">设置留案</button>
                                    </div>
                                    
                                    
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <button type="button" id="searchBtn2" class="btn btn-success">导入</button>
                                        <button type="button" id="searchBtn3" class="btn btn-success">导出</button>
                                    </div>
                ...
                <div id="testmodal" style="padding: 5px 20px;">
                    <form id="antoform" class="form-horizontal calender" role="form">
                        <div class="form-group">
                            <label class="col-sm-3 col-md-4 control-label">请择外催公司</label>
                            <div class="col-sm-4 col-md-4">
                                <select id="debitSource" name="debitSource" class="form-control" required>
                                    <option value="">默认平均分配</option>
...
<!-- 案件回收-->
<div id="wwdebit_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
