...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cdn.bootcss.com/chosen/1.8.3/chosen.min.css"/>
    <style type="text/css">
        .col-sm-7 {
            margin: 2% 0;
        }
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">添加民盛商户</h4>
                                </div>
                                        ...
                                        <form id="antoform" class="form-horizontal calender" role="form">
                                            <div class="form-group" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <select name="storeId" style="width: 150px;" id="storeId" class="dept_select form-control">
                                            ...
                                            <div class="form-group" style="margin-bottom: 5px;">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">民盛平台编号：</label>
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="">修改民盛商户</h4>
                            </div>
                            <div class="modal-body">
                                <div id="" style="padding: 5px 20px;">
                                    <form id="deitFormId" class="form-horizontal calender" role="form">
                                        <div class="form-group" style="margin-bottom: 5px;">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">商家名称：</label>
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <select name="storeId" style="width: 150px;" id="storeId" class="dept_select2 form-control">
                                                    <c:forEach items="${stores}" var="store">
...
<%@ include file="/WEB-INF/common/resource_js.jsp" %>
	<script type="text/javascript" src="https://cdn.bootcss.com/chosen/1.6.1/chosen.jquery.js"></script>
<script>
    $(function () {
         //搜索 框
         
    	 $('.dept_select').chosen({ allow_single_deselect: true,width:"100%"});
    	 $('.dept_select2').chosen({ allow_single_deselect: true,width:"100%"});
        // 初始化DataTables
        var table = $('#datatable_List').dataTable({
            ...
            ajaxSource: '${pageContext.request.contextPath}/mfq/longloan/findLongLoanStoreList.do',
            ...
            columns: [
                ...
                },
                {
                	"data": function (obj) {
                		if (obj.updateTime == null) {
                			...
                			return getMyDate(obj.updateTime);
                		}
                	}
                },
                {
                ...
                {
                    "data": function (obj) {
                        return '<span style="padding-right: 10px;cursor: pointer;color: #1abb9c;" data-toggle="modal;" onclick="edit(\'' + obj.id + '\',\'' + obj.storeName + '\',\'' + obj.code + '\',\'' + obj.remarks + '\',\'' + obj.storeId + '\')">修改' +
    ...
    function subEdit(formId) {
        /*
        var assetCode = $("#" + formId + " input[name='code']").val();
        ...
        */
        ...
        var longLoanStoreVO =  $("#" + formId).serialize();
        if ("antoform" == formId){ // 添加 操作
        	$.ajax({
                url: "${pageContext.request.contextPath}/mfq/longloan/saveLongLoanStoreVO.do", // insertLongLoanStoreVO
                type: "post",
                data: longLoanStoreVO,
                dataType : 'json',
        ...
        } else if ("deitFormId" == formId) { // 修改操作
        	$.ajax({
                url: "${pageContext.request.contextPath}/mfq/longloan/updateLongLoanStoreVO.do", 
                type: "post",
                data: longLoanStoreVO,
                dataType : 'json',
                success: function (data) {
    ...
    function deleteCode(id) {
        if (confirm('确认删除吗 ?')) {
            $.ajax({
                url: "${pageContext.request.contextPath}/mfq/longloan/deleteLongLoanStoreByStoreId.do?id=" + id,
                type: "post",
                data: '',
                processData: false,
                contentType: false,
