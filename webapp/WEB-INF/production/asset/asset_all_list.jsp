    ...
    <div class="">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="margin:0;">
                    <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                    <div  ${handleType != '01' ? 'class="col-md-12 col-sm-12 col-xs-12 form-group" style="padding:0;"' :'class="col-md-6 col-sm-6 col-xs-12 form-group"'} style="padding-left:0;">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                        <button type="button" class="btn btn-primary" id="query" style="margin-left: 20px;">查询</button>
                        <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#export_modal" style="margin-left: 20px;">导出
                        </button>
                    </div>
                    </div>
...
<div id="export_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   	<form id="exportForm" action="${pageContext.request.contextPath}/mfq/asset/exportAssetExcel.do" method="post">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var table = $('#datatable_List').dataTable({
            ...
            ajaxSource: '${pageContext.request.contextPath}/mfq/asset/getList/${handleType}.do',
            ...
            columns: [
                ...
                {"data": "syCreateTime","defaultContent": ""},
                ...
                {"data": "syBackTime","defaultContent": ""}
	...
	$("#btnExport").click(function(){
        ...
        var url = '${pageContext.request.contextPath}/mfq/asset/exportAssetExcel.do';
