    				...
    				<div class="row title_left">
    					<div class="span6">
 						...
 						<ul class="breadcrumb">
 							<li><a herf="#">贷后管理</a></li>
 						 	<li><a herf="#">贷后订单</a></li>
 						 	<li class="active"><a href="#">民盛订单</a></li>
 						</ul>
    					</div>
    				</div>
    			</div>
		...
		$(function() {
			...
			var table = $('#datatable_repayment_list').dataTable({
	            ...
	            fnServerData: function (sSource, aoData, fnCallback) {
	            		...
	            		aoData.push({ "name": "lenderId", "value": "c22fe236afe54dd495fca9914f684d47" }); // 代表是民盛订单加载【对应的放款机构中的民盛机构id】
	            		console.log(aoData)
	            		$.ajax( {
	            			type: 'POST',
	            			url: sSource,
	            ...
	            columns: [
	                ...
	                { "data": function(obj) {
	                		return '<a href="${pageContext.request.contextPath}/mfq/repayment/detail.do?orderNo=' 
	                				...
	                				+ obj.repaymentDetailId + '&pageValue=02'
