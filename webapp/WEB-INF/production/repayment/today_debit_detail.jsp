            ...
            <div class="row title_left">
                <div class="span6">
                    ...
                    <ul class="breadcrumb">
                        <li><a herf="#">贷后管理</a></li>
                        <li><a herf="#">贷后订单</a></li>
                        <li><a href="#" id="gptitle">今日扣款</a></li>
                        ...
                        <div class="table-responsive">
                            <table id="" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <th>备注</th>
                                    <th>负责人</th>
                                    <th><a class="btn btn-primary" id="download"
                  href="${i.downloanUrl}" download="cropped.png"style="padding: 0;color:#26b99a;background:#ffffff;border:0;">下载</a></th>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <c:if test="${userBaseInfoVO.creditNum == null }">
                                                ...
                                                <c:if test="${userInfoDTO.bank.creditNum == '0' }">
                                                    0 张
                                                </c:if>
                                                <c:if test="${userInfoDTO.bank.creditNum == '1' }">
                                                    1 张
                                                </c:if>
                                                <c:if test="${userInfoDTO.bank.creditNum == '2' }">
                                                    2 张
                                                </c:if>
                                                <c:if test="${userInfoDTO.bank.creditNum == '3' }">
                                                    3 张
                                                </c:if>
                                                <c:if test="${userInfoDTO.bank.creditNum == '4' }">
                                                    4 张
                                                </c:if>
                                                <c:if test="${userInfoDTO.bank.creditNum == '5' }">
                                                    5 张
                                                </c:if>
                                                <c:if test="${userInfoDTO.bank.creditNum == '6' }">
                                                    更多
                                                </c:if> --%>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-body">
                                        <div style="padding: 5px 20px;">
                                            <form id="editBack" class="form-horizontal calender"
                                                ...
                                                <div class="form-group" style="margin-bottom: 5px;">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">验证码</label>
                                                    ...
                                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                                        <input type="button" class="btn btn-success antoclose" id="btntime" style="float:right;margin-right: 0;" value="发送验证码"/>
                                                    </div>
                                                </div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-right:0;">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <button class="btn btn-success source" style="padding: 6px 19px;border:0;"
                            onclick="window.open('${pageContext.request.contextPath}/mfq/report/reportPersonTongdun.do?orderId=${orderVO.id}')">
                        同盾风险
                    </button>

                    <button class="btn btn-success source" style="padding: 6px 19px;border:0;"
                            onclick="window.open('${pageContext.request.contextPath}/mfq/report/getBlackList.do?orderId=${orderVO.id}')">
                        数美逾期
                    </button>
                    ...
                    <button class="btn btn-default source"
                            ...
                            onclick="window.open('${pageContext.request.contextPath}/mfq/report/getTaobaoReport.do?userId=${orderVO.customerId}')">
                        淘宝报告
                    </button>

                    <button class="btn btn-default source" style="background:#f0ad4e;color:#ffffff;border:0;"
                            onclick="window.open('${pageContext.request.contextPath}/mfq/report/getAlipayReport.do?userId=${orderVO.customerId}')">
                        支付宝报告
                    </button>
                ...
                <div id="testmodal" style="padding: 5px 20px;">
                    <form id="antoform" class="form-horizontal calender" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="text" class="form-control" id="debitMoney" name="debitMoney" maxlength="9" data-inputmask-regex="(^[1-9]([0-9]+)?(\.[0-9]{1,3})?$)|(^(0){1}$)|(^[0-9]\.[0-9][0-9]([0-9])?$)" placeholder="0.000" />
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div style="padding: 5px 20px;">
                     <form id="updateBaseId" class="form-horizontal calender"role="form">
                         <div class="form-group" style="padding-bottom: 15px;border-bottom:1px solid #a29e9e;">
                             <div class="col-md-2 col-sm-2 col-xs-12">
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12">
                                     <label> <input type="radio"
                                                    name="radio1"
                                                    value="option2" onclick="tonghua1()"/>
                                      无效通话
                                     </label>
                                 </div>
                         </div>
                         ...
                         <div class="form-group" style="margin-bottom: 15px;" id="xuanzeqk2">
                             <div class="control-label col-md-2 col-sm-2 col-xs-12" style="padding-top:0;">
                                 <select class="form-control" id="">
                                      <option value="">有能力无意愿</option>
                                      <option value="">有意愿无能力</option>
                                      <option value="">有意愿有能力</option>
                                      <option value="">无意愿无能力</option>
                         ...
                         <div class="form-group" style="margin-bottom: 15px;" id="xuanzeqk4">
	                          ...
	                          <input class="col-md-9 col-sm-9 col-xs-12" type="file" onchange="imgChange('save_url1')" id="img_save_url1" value="选择文件上传" style="overflow: hidden;">
	                     </div>
            ...
            <div class="modal-footer" style="text-align:center;"> 
                <button type="button" class="btn btn-primary antosubmit" data-dismiss="modal">确认</button>
                <button type="button" class="btn btn-default antoclose" data-dismiss="modal">关闭</button>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function GetRequest() {   
		   ...
		   if(theRequest.pageValue == 03){
			   $('#gptitle').text('催收订单')
			   $('#advance').css('display','block')
			   $('#cancel').css('display','block')
		   }else if(theRequest.pageValue == 02){
			   $('#gptitle').text('民盛订单')
   ...
   /*  function repaymentPrincipal() {
    ...
    $(function () {
    	...
    	var xdata = xurl.split('&')
    	var xpage = xdata[5].split('=')
    	if(xpage[1] == 01){
 ...
 // 提前还款 或 用户退款
   /*  function advanceOrCancel(debitType) {
        ...
        var firstRepaymentDate = '${repaymentDetailList[0].repaymentDate}';
        // 计算提前还款/退款需要支付的金额
        var date=new Date(firstRepaymentDate); 
        // orderId
        var orderId = '${orderVO.id}';
        // repaymentId
        var repaymentId = '${orderRepaymentVO.id}';
...
/*     function payList(repaymentId) {
    	var currentStage = '${orderRepaymentVO.currentStage }';
    	var repayid = repaymentId.split(',')
    	var repaymentIdNow = repayid[0];
    	var status = repayid[1];
    	var repaymentStage = repayid[2];
    	console.log(repaymentIdNow,status,repaymentStage);
    		 if (repayid[0] == null || repayid[0] == '') {
    	            $.confirm({
    	                title: '系统提示',
    	                text: "信息有误,请刷新重试!",
    	                confirmButton: '确认',
    		 ...
    		 if(status == currentStage && repaymentStage == "11" ){
    			  orderRepaymentDwr.findPayList(repaymentIdNow,status,repaymentStage,
    	    	            {
    		 ...
    		 }else if(status==1 && repaymentStage == "12" ){
    			  orderRepaymentDwr.findPayList(repaymentIdNow,status,repaymentStage,
    	    	            {
    	    	                callback: function (res) {
    	    	                	console.log(res);
