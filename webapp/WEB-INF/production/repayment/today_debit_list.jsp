    				...
    				<div class="row title_left">
    					<div class="span6">
 						...
 						<ul class="breadcrumb">
 							<li><a herf="#">贷后管理</a></li>
 						 	<li><a herf="#">贷后订单</a></li>
 						 	<li class="active"><a href="#">今日扣款</a></li>
 						</ul>
    					</div>
    				</div>
    			</div>
	                    		...
	                    		<div class="control-group">
                            		<div class="controls">
                              		...
                              		<div class="col-md-4 col-sm-4 col-xs-12 form-group has-feedback">
                              			<div class="control-label col-md-4 col-sm-4 col-xs-4" style="padding-right:0;"><input type="text" class="form-control" style="background:#fff;padding-right: 12px;" id="" name="" value="还款时间" readonly/></div>
	                    					<div class="col-md-8 col-sm-8 col-xs-8" style="padding-left:0;">
                          					<input type="text" class="form-control has-feedback-left" id="repaymentDate" placeholder="" aria-describedby="inputSuccess2Status">
                                				<span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true" style="left:1px;"></span>
		...
		$(function() {
			...
			var table = $('#datatable_repayment_list').dataTable({
	            ...
	            fnServerData: function (sSource, aoData, fnCallback) {
	            		...
	            		// 往后台封装数据，json格式的字符串
	            		aoData.push({ "name": "pageName", "value": "TODAY" });
	            		...
	            		aoData.push({ "name": "repaymentDate", "value": repaymentDate });
	            ...
	            columns: [
	                ...
	                { "data": "realName","defaultContent": ""},//姓名
	                { "data": "storeName","defaultContent": ""},//商户名称
	                { "data": "repaymentStage","defaultContent": "" },//当前期
	                { "data": "currentStage" ,"defaultContent": ""},//已还款期数
	                { "data": "overdueNo","defaultContent": "" },//逾期天数
	                { "data": function(obj) {//还款日
	                		return new Date(parseInt(obj.repaymentDate)).format('yyyy-MM-dd');
	                },"defaultContent": ""},
	                { "data": function(obj) {//月还
                		return obj.repaymentMoney;
               		 },"defaultContent": ""},
	                
	                /* { "data": function(obj) {
	                		var type;
	                		switch (obj.chergeWay) {
	                			case 'NORM':
	                				type = '正常';
	                				break;
	                			case 'CANC':
	                ...
	                { "data": function(obj) {
	                		return '<a href="${pageContext.request.contextPath}/mfq/repayment/detail.do?orderNo=' 
	                				...
	                				+ obj.repaymentDetailId + '&pageValue=01'
