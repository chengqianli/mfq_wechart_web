					...
					.dataTable(
							{
								...
								ajaxSource : '${pageContext.request.contextPath}/mfq/order/getList/alreadyLoan.do',
								...
								columns : [
											{
											    ...
											    render: function (data, type, row, meta) {
											    	...
											    	return "<a style='color:#3396c7;' href='${pageContext.request.contextPath}/mfq/order/getOrderDetails/" + row.orderId + "/alreadyLoan.do' style='cursor: pointer; text-decoration: underline; target='_blank'>"+row.orderNo+"<font style='color: #e74c3c;'>"+rowsplitNo+"</font>"+"</a>";
											    }
										    },
