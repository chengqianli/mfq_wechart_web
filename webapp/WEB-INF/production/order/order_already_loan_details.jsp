									...
									<li><a href="#step-1" class="done" isdone="1"> <span
											...
											<li><a href="#step-1" class="done" isdone="1"> <span
													class="step_no">2</span> <span class="step_descr">
														<span style="color:#ffffff;">审核</span>审核通过<span style="color:#ffffff;">审核</span><br /> <small>
														<c:forEach
											...
											<li><a href="#step-1" class="done" isdone="1"> <span
													class="step_no">3</span> <span class="step_descr">
														<span style="color:#ffffff;">审</span>已分配放款机构<span style="color:#ffffff;">审</span><br /> <small><c:forEach
																items="${orderCheckLog}" var="i">
																<c:if
										...
										<c:when
											...
											<c:choose>
												<c:when
													...
													<li><a href="#step-1"  class="done"> <span class="step_no">4</span>
															<span class="step_descr"> <span style="color:#ffffff;">审核中</span>已签署<span style="color:#ffffff;">审核中</span><br /> <small>${orderProgress.orderContractSignTime}</small>
														</span>
													</a></li>
																...
																<c:if test="${i.submitStatus=='TRUE'}">
																	<div class="ln_solid"
																		...
																		<!-- <button type="button" class="btn btn-primary"
																			...
																			<a class="btn btn-primary" target="_blank" href="${i.viewUrl}" style=" padding: 0;color:#26b99a;background:#ffffff;border:0;float: right;">查看</a>
																...
																<c:if test="${i.submitStatus=='FALSE'}">
																	<div class="ln_solid"
																		...
																		<button type="button" class="btn btn-primary"
																			...
																			<div style="color: #FFFFFF;" onclick="againLoan('${i.contractId}')">生成</div>
																		</button>
																	</div>
																</c:if>
															</div>
													...
													<c:forEach items="${orderCheckLog}" var="i">
														<tr>
															...
															<td>
																...
																<c:if test="${i.checkStatus=='06' || i.checkStatus=='07'}">已放款</c:if>
															</td>
															<td>${i.createTime}</td>
															<td>${i.remark}</td>
														</tr>
