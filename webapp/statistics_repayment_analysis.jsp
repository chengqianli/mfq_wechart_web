                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 10px;">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2 style="line-height: 1;font-size: 18px;">今日正常还款数据</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <!--form表单-->
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 10px;">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2 style="line-height: 1;font-size: 18px;">今日逾期还款数据</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <!--form表单-->
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12" style="margin-top: 10px;">
                            <div class="x_panel">
                                <div class="x_title">
                                    <!-- 小标题-->
                                    <h2 style="line-height: 1;font-size: 18px;">贷后数据分析</h2>
                                    <!--右侧时间显示-->
                        ...
                        <div class="col-md-12 col-xs-12" style="margin-top: 10px;">
                            <div class="x_panel">
                                <!--小表头-->
                                <div class="x_title">
                                    <h2 style="line-height: 1;font-size: 18px;">正常还款数据</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <!--form表单内容区-->
                                <div class="x_content">
                        ...
                        <div class="col-md-12 col-xs-12" style="margin-top: 10px;">
                            <div class="x_panel">
                                <!--小表头-->
                                <div class="x_title">
                                    <h2 style="line-height: 1;font-size: 18px;">逾期还款数据</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <!--form表单内容区-->
                                <div class="x_content">
