            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            <h4 style="font-size:16px;">投保情况&保单信息</h4>
                            <table id="" class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th>保险名称</th>
                  ...
                  href="${i.downloanUrl}" download="cropped.png"style="padding: 0;color:#26b99a;background:#ffffff;border:0;">下载</a></th>
                        ...
                        <div class="table-responsive">
                            <h4 style="font-size:16px;">操作记录</h4>
                            <table id="" class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th>时间</th>
                ...
                <div id="testmodal" style="padding: 5px 20px;">
                    <form id="antoform" class="form-horizontal calender" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <input type="text" class="form-control" id="debitMoney" name="debitMoney" value="0.00" maxlength="5"
                                       data-inputmask-regex="(^[1-9]([0-9]+)?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)"
                                       placeholder="0.00">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).on('click', ".btn-group > .dropdown-menu > li > a", function () {
            ...
            if (debitType != '') {
                initModalLabel(debitType, repaymentDetailId, thisStage);
                $('#fc_debit').click();
            }
        });
            ...
            columns: [
                      ...
                      },
                      {
                          "data": function (obj) {
                              ...
                              var thirdStr = '';
                              var partStr = '';
                              if (obj.status === '02' || obj.status === '07') {

                              } else {
                                  var longLoan = $("#longLoan").val();
                                  if (longLoan != '' && longLoan != null) { // 证明是从民盛订单进来的详情
                                  } else {
                                      manualStr = '<li><a href="javascript:void(0);" thisStage="'+ obj.repaymentStage +'" rel="manual" class="' + obj.id + '">手动扣款</a></li>';
                                      partStr = '<li><a href="javascript:void(0);" thisStage="'+ obj.repaymentStage +'" rel="part" class="' + obj.id + '">部分扣款</a></li><li class="divider"></li>';
                                      // partStr = '<li class="divider"></li>';
                                  }
                                  thirdStr = '<li><a href="javascript:void(0);" thisStage="'+ obj.repaymentStage +'" rel="third" class="' + obj.id + '">三方扣款</a></li>';
 ...
 // 提前还款 或 用户退款
   /*  function advanceOrCancel(debitType) {
    ...
    function initModalLabel(debitType, repaymentDetailId, thisStage) {
    ...
    function checkModalForm(debitMoney, debitType, thirdMoney, debitSource, detailPaymentStage) {
        ...
        if (debitType === 'third') {
            ...
            var rpMoney = Number($("#rpMoney").text().trim());
            var thirdMoneyN = Number(thirdMoney);
            if (thirdMoneyN < rpMoney){
            	message = '三方已收金额不能低于月还金额！';
            }
